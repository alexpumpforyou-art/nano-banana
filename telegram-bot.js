...
Я — ваш персональный ИИ-ассистент. Вот что я умею:

1️⃣ **Отвечать на вопросы**
Просто напишите любой вопрос или текст.
_Пример: "Придумай идею для поста в Instagram"_

2️⃣ **Рисовать картинки**
Напишите "нарисуй" или "создай" перед описанием.
_Пример: "Нарисуй футуристический город"_

3️⃣ **Редактировать фото**
Отправьте мне фото и напишите, что изменить.
_Пример: "Добавь солнечные очки"_
